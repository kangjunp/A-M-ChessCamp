class InstructorsController < ApplicationController
  ...
  private
    ...
    def instructor_params
      params.require(:instructor).permit(:first_name, :last_name, :picture, :bio, :email, :phone, :active, user_attributes: [:username, :active, :password, :role, :id, :active, :password_confirmation])
    end
end
